  ...
  return (
    ...
    >
      <form
        ...
        className="relative h-dvh w-full grid
          grid-cols-[5fr_2.5fr]
          grid-rows-[5fr_3fr_5fr]"
      >
        {/* Title row */}
        {/* <div className="md:col-span-2 px-6 md:px-12 pt-8 md:pt-10 pb-6 md:pb-8 border-b-2 border-b-red-500 border-dashed">
          <h2 className="text-2xl sm:text-3xl md:text-5xl tracking-[0.35em] text-red-500 uppercase">
            [Contact]
          </h2>
        </div> */}

        {/* Row 1: Sender email (left) | empty right with vertical divider */}
        <div className="flex flex-col justify-between px-6 py-6 border-b-4 border-b-gray-600 border-dashed md:border-r-4 md:border-r-red-500
          md:py-20  md:px-18">
          <h2 className="text-2xl tracking-[0.35em] text-red-500 uppercase
          sm:text-3xl md:text-5xl text-center md:text-left">
          ...
          <div className="flex flex-col justify-between">
            ...
            <input
              ...
              className="w-full bg-transparent text-gray-300 text-sm tracking-[0.2em] uppercase
        ...
        <div
          aria-hidden="true"
          className="hidden md:block border-b-4 border-b-gray-600 border-dashed"
        />

        {/* Row 2: Payload header (left) | Socials (right) */}
        <div className="flex sm:flex-col justify-between px-6 md:px-18 py-6 md:py-20 border-b-4 border-b-gray-600 border-dashed md:border-r-4 md:border-r-red-500">
          <div className="flex flex-col justify-between">
          ...
          <input
            ...
            className="w-full bg-transparent text-gray-300 text-sm md:text-base tracking-[0.2em] uppercase
              border-0 border-b-2 border-dashed border-red-500
              focus:outline-none focus:border-red-500 focus:text-red-400
              placeholder:text-gray-500 py-2 px-0"
          />
        </div>
        <div className="px-6 md:px-10 py-6 md:py-8 border-b-4 border-b-gray-600 border-dashed flex items-center justify-center">
        ...
        <div className="flex sm:flex-col justify-between px-6 md:px-18 py-6 md:py-15 border-b-4 border-b-gray-600 border-dashed md:border-r-4 md:border-r-red-500">
          <div className="flex flex-col justify-between">
          ...
          <textarea
            ...
            className="flex-1 min-h-[140px] w-full resize-none bg-transparent
              text-gray-300 text-sm md:text-base tracking-[0.15em] uppercase leading-relaxed
