    ...
    >
      <div className="relative h-full w-full">
        ...
        <div className="flex flex-col md:grid h-full w-full md:grid-cols-[1fr_1fr_.618fr] md:grid-rows-[0.618fr_1fr_.618fr] text-gray-400">
          ...
          <div className="md:col-span-2 md:row-start-1 md:row-end-2 md:border-b-4 md:border-b-red-500 md:border-r-4 md:border-r-gray-600 md:border-dashed flex flex-col md:flex-row items-center justify-center md:justify-center gap-4 md:gap-20 py-6 px-4 border-b-4 border-b-red-500 flex-1 md:flex-auto">
            {/* Mobile: Photo first */}
          ...
          <div className="hidden md:block col-start-1 row-start-2 row-end-3 border-b-4 border-b-red-500 border-r-4 border-r-gray-600 border-dashed" />
          ...
          <div className="md:col-start-3 md:row-start-2 md:row-end-3 md:border-b-4 md:border-b-red-500 md:border-dashed px-6 py-6 md:px-10 md:py-8 flex items-center border-t-4 border-t-gray-600 md:border-t-0 flex-1 md:flex-auto">
          ...
          <div className="col-span-1 md:col-start-2 md:col-end-4 row-start-3 md:row-start-3 md:row-end-4 flex items-center justify-center px-6 py-4 md:py-0 md:px-8 border-t-4 border-t-red-500 md:border-t-0 flex-1 md:flex-auto">
            <span className="text-[0.65rem] sm:text-[0.75rem] md:text-sm lg:text-2xl lg:font-black tracking-[0.4em] sm:tracking-[0.6em] text-gray-500 uppercase flex items-center gap-3 sm:gap-5">
