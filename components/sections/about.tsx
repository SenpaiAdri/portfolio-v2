    ...
    >
      <div className="relative h-full w-full">
        ...
        <div className="flex flex-col md:grid h-full w-full md:grid-cols-[1fr_1fr_.618fr] md:grid-rows-[0.618fr_1fr_.618fr] text-gray-400">
          ...
          <div
            className="hidden md:flex col-start-3 row-start-1 row-end-2 border-b-4 border-b-red-600 border-dashed items-center justify-center"
            aria-hidden="true"
          />

          {/* MOBILE: Hidden | DESKTOP: Row 2 - Left empty panel */}
          <div
            className="hidden relative md:flex col-start-1 row-start-2 row-end-3 border-b-4 border-b-red-600 border-r-4 border-r-gray-600 border-dashed items-center justify-center"
            aria-hidden="true"
          >
          ...
          <div className="relative md:col-start-2 md:row-start-2 md:row-end-3 md:border-b-4 md:border-b-red-600 md:border-r-4 md:border-r-gray-600 md:border-dashed px-6 py-6 md:px-10 md:py-8 flex items-center flex-1 md:flex-auto">
          ...
          <div className="relative md:col-start-3 md:row-start-2 md:row-end-3 md:border-b-4 md:border-b-red-600 md:border-dashed px-6 py-6 md:px-10 md:py-8 flex items-center border-t-2 border-t-gray-600 border-dashed md:border-t-0 flex-1 md:flex-auto">
            <BackdropGrid />
            <p className="text-sm sm:text-base md:text-base text-gray-400 leading-snug text-center md:text-left">
              <span className="text-red-600">- </span>This is the version 2 of
              ...
              <a
                ...
                className="text-red-600 underline decoration-dashed underline-offset-4 hover:text-red-500"
                target="_blank"
          ...
          <div
            className="hidden md:block col-start-1 row-start-3 row-end-4 border-r-4 border-r-gray-600 border-dashed"
            aria-hidden="true"
          />
          ...
          <div className="col-span-1 md:col-start-2 md:col-end-4 row-start-3 md:row-start-3 md:row-end-4 flex items-center justify-center px-6 py-4 md:py-0 md:px-8 border-t-2 border-t-red-600 border-dashed md:border-t-0 flex-1 md:flex-auto">
            <h2 className={cn(SECTION_TAGLINE, "sm:gap-5")}>
              <Layers
                className="w-4 h-4 sm:w-8 sm:h-8 text-red-600"
                aria-hidden="true"
              />
