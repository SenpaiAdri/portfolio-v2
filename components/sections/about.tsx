        ...
        <div className="flex flex-col md:grid h-full w-full md:grid-cols-[1fr_1fr_.618fr] md:grid-rows-[0.618fr_1fr_.618fr] text-gray-400">
          ...
          <div className="md:col-start-3 md:row-start-2 md:row-end-3 md:border-b-4 md:border-b-red-500 md:border-dashed px-6 py-6 md:px-10 md:py-8 flex items-center border-t-2 border-t-gray-600 border-dashed md:border-t-0 flex-1 md:flex-auto">
            <p className="text-sm sm:text-base md:text-base text-gray-400 leading-snug text-center md:text-left">
              <span className="text-red-500">- </span>This is the version 2 of my portfolio and still working on the design and content. You may check out my v0 portfolio <a href="https://eydriannn-v0.vercel.app" className="text-red-500 underline decoration-dashed underline-offset-4 hover:text-red-400" target="_blank" rel="noopener noreferrer">here</a>.  
            </p>
          </div>
