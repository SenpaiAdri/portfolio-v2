...
export default function NotFound() {
  return (
    <main className="relative flex h-dvh w-screen flex-col items-center justify-center gap-6 overflow-hidden bg-[#0a0a0a] px-6">
      ...
      <p className="relative z-10 text-red-600 text-xs md:text-sm tracking-[0.35em] uppercase">
        [ Error 404 ]
      </p>
      ...
      <Link
        href="/"
        className="relative z-10 inline-flex items-center gap-3 border-2 border-dashed border-gray-600 px-8 py-3 text-gray-400 text-xs md:text-sm tracking-[0.3em] uppercase transition-colors hover:border-red-600 hover:text-red-600 focus-visible:border-red-600 focus:outline-none"
      >
        [ Return Home ]
      </Link>
    </main>
